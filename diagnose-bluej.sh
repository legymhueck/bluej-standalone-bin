...
BLUEJ_HOME="${BLUEJ_HOME:-/opt/bluej}"
JAVA_HOME="${BLUEJ_HOME}/jdk"
JFX_LIB="${BLUEJ_HOME}/javafx/lib"
...
echo "== Starting Bluej with JavaFX verbose logging (close the app afterward) =="
